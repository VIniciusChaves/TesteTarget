...
for dia in dados:
    valor = dia["valor"]
    if valor > 0:
        valores_faturamento.append(valor)
...
media_faturamento = total_faturamento / \
    len(valores_faturamento) if valores_faturamento else 0

dias_acima_media = sum(
    1 for valor in valores_faturamento if valor > media_faturamento)
